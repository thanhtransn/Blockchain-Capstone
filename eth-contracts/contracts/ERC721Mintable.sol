...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != msg.sender,
            "address to must not be the owner of the tokenId"
        );
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == ownerOf(tokenId) ||
                isApprovedForAll(ownerOf(tokenId), msg.sender) == true,
            "Caller is not permission to perform"
        );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(
            ...
            "This tokenId already exists, please give other tokenId"
        );
        require(
            to != address(0),
            "This address is invalid, please give other tokenId"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "The from address must be the owner of this token"
        );
